    ...
    return function e(t, n, o) {
      ...
      7: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
          var n, a, r, s, l, d, u, c, f, h, p, m, w, b, g, v, k, y, _, x, S, M, C, E, R;
          n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, R = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, w = n.bits, b = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
          e: do {
            ...
            t: for (;;) {
              if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _) R[s++] = 65535 & y;
                ...
                x = 65535 & y, _ &= 15, _ && (_ > w && (m += E[a++] << w, w += 8), x += m & (1 << _) - 1, m >>>= _, w -= _), 15 > w && (m += E[a++] << w, w += 8, m += E[a++] << w, w += 8), y = g[m & k];
                n: for (;;) {
                  ...
                  if (S = 65535 & y, _ &= 15, _ > w && (m += E[a++] << w, w += 8, _ > w && (m += E[a++] << w, w += 8)), S += m & (1 << _) - 1, S > u) {
          ...
          x = w >> 3, a -= x, w -= x << 3, m &= (1 << w) - 1, e.next_in = a, e.next_out = s, e.avail_in = r > a ? 5 + (r - a) : 5 - (a - r), e.avail_out = d > s ? 257 + (d - s) : 257 - (s - d), n.hold = m, n.bits = w
        }
      }, {}],
      8: [function(e, t, n) {
        "use strict";
        ...
        function f(e, t) {
          var n, i, a, r, s, l, d, f, h, p, m, w, pe, me, we, be, ge, ve, ke, ye, _e, xe, Se, Me, Ce = 0,
            Ee = new b.Buf8(4),
            Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
          if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return L;
          n = e.state, n.mode === J && (n.mode = K), s = e.next_out, a = e.output, d = e.avail_out, r = e.next_in, i = e.input, l = e.avail_in, f = n.hold, h = n.bits, p = l, m = d, xe = R;
          e: for (;;) switch (n.mode) {
            case U:
              if (0 === n.wrap) {
                n.mode = K;
            ...
            case O:
              ...
              n.head && (n.head.text = f >> 8 & 1), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0, n.mode = T;
            case T:
              for (; 32 > h;) {
                if (0 === l) break e;
                l--, f += i[r++] << h, h += 8
            ...
            case P:
              ...
              n.mode = N;
            case N:
              if (1024 & n.flags && (w = n.length, w > l && (w = l), w && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, i, r, w, _e)), 512 & n.flags && (n.check = v(n.check, i, w, r)), l -= w, r += w, n.length -= w), n.length)) break e;
              n.length = 0, n.mode = q;
            case q:
              if (2048 & n.flags) {
                if (0 === l) break e;
                w = 0;
                do _e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && l > w);
                if (512 & n.flags && (n.check = v(n.check, i, w, r)), l -= w, r += w, _e) break e
            ...
            case G:
              if (4096 & n.flags) {
                if (0 === l) break e;
                w = 0;
                do _e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && l > w);
                if (512 & n.flags && (n.check = v(n.check, i, w, r)), l -= w, r += w, _e) break e
            ...
            case V:
              if (w = n.length) {
                ...
                b.arraySet(a, i, r, w, s), l -= w, r += w, d -= w, s += w, n.length -= w;
                break
              }
              n.mode = J;
              break;
            ...
            case ne:
              if (l >= 6 && d >= 258) {
                e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, k(e, m), s = e.next_out, a = e.output, d = e.avail_out, r = e.next_in, i = e.input, l = e.avail_in, f = n.hold, h = n.bits, n.mode === J && (n.back = -1);
                break
              }
        ...
        var m, w, b = e("../utils/common"),
          ...
          be = we,
          ge = !0;
        n.inflateReset = r, n.inflateReset2 = s, n.inflateResetKeep = a, n.inflateInit = d, n.inflateInit2 = l, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = p, n.inflateInfo = "pako inflate (from Nodeca project)"
      }, {
        "../utils/common": 1,
        "./adler32": 3,
        "./crc32": 5,
      ...
      9: [function(e, t, n) {
        ...
        t.exports = function(e, t, n, p, m, w, b, g) {
          ...
          if (A > B && (A = B), 0 === B) return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
          for (L = 1; B > L && 0 === N[L]; L++);
          ...
          if (e === s ? (Z = G = b, S = 19) : e === l ? (Z = u, P -= 257, G = c, j -= 257, S = 256) : (Z = f, G = h, S = -1), T = 0, D = 0, F = L, x = w, z = A, I = 0, y = -1, O = 1 << A, _ = O - 1, e === l && O > a || e === d && O > r) return 1;
          for (var H = 0;;) {
            H++, M = F - I, b[D] < S ? (C = 0, E = b[D]) : b[D] > S ? (C = G[j + b[D]], E = Z[P + b[D]]) : (C = 96, E = 0), v = 1 << F - I, k = 1 << z, L = k;
            do k -= v, m[x + (T >> I) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
            for (v = 1 << F - 1; T & v;) v >>= 1;
            if (0 !== v ? (T &= v - 1, T += v) : T = 0, D++, 0 === --N[F]) {
              if (F === B) break;
              F = t[n + b[D]]
            }
            if (F > A && (T & _) !== y) {
              ...
              y = T & _, m[y] = A << 24 | z << 16 | x - w | 0
            }
          }
          return 0 !== T && (m[x + T] = F - I << 24 | 64 << 16 | 0), g.bits = A, 0
        }
      }, {
        "../utils/common": 1
      }],
  ...
  function() {
    var e = function(e) {
      ...
      function n() {
        ...
        }, new t(0, 15650817, 0, 0).open("GET", "/data.unity3d"), new t(15650817, 15651104, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(15651104, 15654070, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(15654070, 17478534, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(17478534, 18959962, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(18959962, 18987587, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_TestBuild.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
          fromCache: !1
        }, l ? (n(l), l = null) : d = n
      }
      var o;
